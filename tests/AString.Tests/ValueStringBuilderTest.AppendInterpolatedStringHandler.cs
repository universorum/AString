...
public class ValueStringBuilderTestAppendInterpolatedStringHandler
{
    [Test]
    public async Task AppendFormattedInt()
    {
        ...
        var handler = new ValueStringBuilder.AppendInterpolatedStringHandler(6, 1, sb1);
    ...
    public async Task AppendFormattedDouble()
    {
        ...
        var handler = new ValueStringBuilder.AppendInterpolatedStringHandler(3, 1, sb1);
    ...
    public async Task AppendFormattedWithFormat()
    {
        ...
        var handler = new ValueStringBuilder.AppendInterpolatedStringHandler(0, 1, sb1);
    ...
    public async Task AppendMultipleFormattedValues()
    {
        ...
        var handler = new ValueStringBuilder.AppendInterpolatedStringHandler(2, 3, sb1);
    ...
    public async Task AppendWithProvider()
    {
        ...
        var handler = new ValueStringBuilder.AppendInterpolatedStringHandler(0, 1, sb1, CultureInfo.InvariantCulture);
    ...
    public async Task AppendChained()
    {
        ...
        var h1 = new ValueStringBuilder.AppendInterpolatedStringHandler(3, 0, sb1);
        h1.AppendLiteral("foo");
        sb2.Append(ref h1);

        var h2 = new ValueStringBuilder.AppendInterpolatedStringHandler(3, 0, sb1);
