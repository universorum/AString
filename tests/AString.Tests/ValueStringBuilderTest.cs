...
public class ValueStringBuilderTestCore
{
    [Test]
    ...
    public async Task Integer(int x, int y)
    {
        ...
        using var sb3 = new ValueStringBuilder();
    ...
    {
        using var sb = new ValueStringBuilder(64);
    ...
    {
        using var sb = new ValueStringBuilder(64, 1000);
    ...
    {
        using var sb = new ValueStringBuilder(null);
        await Assert.That(sb.Length).IsZero();
    ...
    {
        using var sb = new ValueStringBuilder("hello world", 6, 5, 64);
    ...
    {
        using var sb = new ValueStringBuilder(null, 0, 0, 64);
        await Assert.That(sb.Length).IsZero();
    }
    ...
    [Test]
    public async Task EqualsValueStringBuilderTrue()
    {
    ...
    [Test]
    public async Task EqualsValueStringBuilderFalse()
    {
        using var sb1 = new ValueStringBuilder("hello");
        using var sb2 = new ValueStringBuilder("world");
        using var sb3 = new ValueStringBuilder("hell");
    ...
    {
        using var sb1 = new ValueStringBuilder("hello world");
    ...
    {
        using var sb1 = new ValueStringBuilder("hi");
    ...
    [Test]
    public async Task AsSpanSlice()
    {
        using var sb   = new ValueStringBuilder("hello world");
        var       span = sb.AsSpan(6, 5);
        await Assert.That(span.ToString()).IsEqualTo("world");
    }

    [Test]
    public async Task AsSpanSliceFromStart()
    {
        using var sb   = new ValueStringBuilder("hello world");
        var       span = sb.AsSpan(0, 5);
        await Assert.That(span.ToString()).IsEqualTo("hello");
    }
    ...
    [Test]
    public async Task AsMemoryFull()
    {
        using var sb  = new ValueStringBuilder("hello");
        var       mem = sb.AsMemory();
        await Assert.That(mem.ToString()).IsEqualTo("hello");
        await Assert.That(mem.Length).IsEqualTo(5);
    }

    [Test]
    public async Task AsMemorySlice()
    {
        using var sb  = new ValueStringBuilder("hello world");
        var       mem = sb.AsMemory(6, 5);
        await Assert.That(mem.ToString()).IsEqualTo("world");
    }

    [Test]
    public async Task AsMemorySliceFromStart()
    {
        using var sb  = new ValueStringBuilder("hello world");
        var       mem = sb.AsMemory(0, 5);
        await Assert.That(mem.ToString()).IsEqualTo("hello");
    }
    ...
    {
        using var sb  = new ValueStringBuilder(16);
    ...
    {
        using var sb = new ValueStringBuilder("old content");
        sb.Clear();
        sb.Append("new");
    ...
    {
        var sb = new ValueStringBuilder("hello world");
        try
        {
            sb.Length = 5;
            await Assert.That(sb.ToString()).IsEqualTo("hello");
    ...
    {
        var sb = new ValueStringBuilder("hello");
        try
        {
            sb.Length = 0;
            await Assert.That(sb.ToString()).IsEqualTo(string.Empty);
    ...
    {
        var sb = new ValueStringBuilder(1024);
        try
        {
            var oldCap = sb.Capacity;
            sb.Capacity = 1;
