...
#endif
            =>
                FormatterCache<T>.Formatter.TryFormat(in value, destination, out written, format, formatProvider);
...
#endif
            =>
                FormatterCache<T>.Formatter.Format(in value, format, formatProvider);
    }
